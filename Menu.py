    ...
    # Generate stock report
        ...
        if userCommandFiltered.find("?")>=0:
            ...
            if userCommandFiltered.find("bullish")>=0:
                if userCommandFiltered.find("strong")>=0:
                    Functions.generateAutomatedReport("BULL", 144)
                elif userCommandFiltered.find("weak")>=0:
                    Functions.generateAutomatedReport("BULL", 89)
                else:
                    Functions.generateAutomatedReport("BULL", 100)
            elif userCommandFiltered.find("bearish")>=0:
                if userCommandFiltered.find("strong")>=0:
                    Functions.generateAutomatedReport("BEAR", 144)
                elif userCommandFiltered.find("weak")>=0:
                    Functions.generateAutomatedReport("BEAR", 89)
                else:
                    Functions.generateAutomatedReport("BEAR", 100)
            else:
                Functions.generateAutomatedReport("NULL", 100)
        commandLine()
