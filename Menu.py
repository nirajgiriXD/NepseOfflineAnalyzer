...
def menu():
    ...
    print("\t\t7.\tUse 'sector' to view price change in different sectors")
            ...
            if dataIsUpdated()==False and MegaStorage.connectionError==False:
                ...
                if response=="Y" or response=="y":
                    ...
                    if len(shareVolume)>=numberOfCompanies and len(shareReportDate)>=numberOfCompanies:
                        fundamentalDataUpdate()
                        Functions.lineMaker("-", "\n\n\t", 116, "\n")
                        print(f"{MegaStorage.green}\t\t[ Status ] :" + Functions.center(f"Data extraction was successful{MegaStorage.normal}", 60))
                        menu()
                    else:
                        print("I was here (After Phase2 extraction error)")
                        Functions.lineMaker("-", "\n\n\t", 116, "\n")
