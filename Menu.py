...
def programLoader():
    ...
    message2 = ""
    Functions.lineMaker("=", "\n\n\t", 116, "")
    if Functions.isValidUser()==True or MegaStorage.godMode==True:
        ...
        try:
            ...
            if isConnected()==True and isTesting==False:
                if dataIsUpdated()==False and MegaStorage.connectionError==False:
                    print(f"\t\t{MegaStorage.yellow}[ Status ] :" + Functions.center(f"Data is not up to date [ {MegaStorage.fileDate} -> {MegaStorage.dataAsOf} ]{MegaStorage.normal}", 60))
                    Functions.lineMaker("-", "\n\t", 116, "\n")
                    response = input(f"\t\tUpdate Data (Y/N):\t")
                    Functions.lineMaker("-", "\n\t", 116, "\n")
                    if response=="Y" or response=="y":
                    ...
                    allFilesArePresent(True)
                    message1 = f"{MegaStorage.yellow}\t\t[ Message ] :" + Functions.center(f"Sever connection failed (Data loaded successfully from file [ {MegaStorage.fileDate} ] ){MegaStorage.normal}", 60)
                    message2 = f"{MegaStorage.red}\t\t[ Error ] :" + Functions.center(f"Failed to load data{MegaStorage.normal}", 60)
                    if dataLoader(message1, message2)==True:
                        menu()
                else:
                    allFilesArePresent(True)
                    message1 = f"{MegaStorage.green}\t\t[ Status ] :" + Functions.center(f"Data is up to date and has been loaded successfully from file [ {MegaStorage.fileDate} ]{MegaStorage.normal}", 60)
                ...
                allFilesArePresent(True)
                message1 = f"{MegaStorage.green}\t\t[ Status ] :" + Functions.center(f"Data loaded successfully in offline mode [ {MegaStorage.fileDate} ]{MegaStorage.normal}", 60)
        ...
        print(Functions.center(f"{MegaStorage.bold}Stock Analyzer - Intruder{MegaStorage.normal}", 121))
        Functions.lineMaker("=", "\t", 116, "\n")
