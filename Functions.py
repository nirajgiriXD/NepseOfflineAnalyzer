...
def clearReportDataStorage():
    ...
    MegaStorage.shareReportData.clear()
...
def progressIndicator(index, total):
    ...
    if float(progressIndicatorPercentage)>=MegaStorage.barProgressCount:
...
def companyDataDisplay(index):
    ...
    print("\t\tMarket Capitalisation = "+str(MegaStorage.MarketCapitalisation[index]))
    print("")
...
def generateCompanyReport(index):
    pass
