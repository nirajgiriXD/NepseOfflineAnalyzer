...
def messageDisplay(topic, message):
    print("\n\t-------------------------------------------------------------------------------------------------------------------")
    print(f"\t\t[ {topic} ] :" + center(message, 60))
...
def generateSimpleSingleCompanyReport(index):
    ...
    print("\t===================================================================================================================\n\n")
    print(f"\t\t\t{MegaStorage.shareMovingAnalysis1[index]} (MA5)\t\t\t\t{MegaStorage.shareSupportLevel1[index]} (S1)\t\t\t{MegaStorage.shareResistanceLevel1[index]} (R1)")
    ...
    print(f"\t\t\t{MegaStorage.shareMovingAnalysis3[index]} (MA180)\t\t\t\t{MegaStorage.shareSupportLevel3[index]} (S3)\t\t\t{MegaStorage.shareResistanceLevel3[index]} (R3)")
    print("\n\t-------------------------------------------------------------------------------------------------------------------")
    print(f"\n\t\t\t{avgValue1} ({MegaStorage.MarketPrice[index]}){center(avgValue2, 40)}\t\t\t\t{avgValue3}\n")
...
def generateAdvanceSingleCompanyReport(index):
    pass

def generateAdvanceAllCompanyReport(index):
    pass
