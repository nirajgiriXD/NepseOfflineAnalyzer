def menuDef():
    print("\n\t-------------------------------------------------------------------------------------------------------------------\n")
    print("\t\tDescription:")
    print("\t\tMenu shows available commands.")
    print("\n\t\tFormat:")
...
def comparedef():
    print("\n\t-------------------------------------------------------------------------------------------------------------------\n")
    print("\t\tDescription:")
    print("\t\tCompare allows user to compare between any two companies of any sector.")
    print("\n\t\tFormat:")
...
def rangeDef():
    ...
    print("\t\tFactor>         eps")
    print("\t\tEnter lower limit: 20")
    print("\t\tEnter upper limit: 100\n")
...
def chartDef():
    print("\n\t-------------------------------------------------------------------------------------------------------------------\n")
    print("\t\tDescription:")
    print("\t\tChart displays a simple chart of the mentioned company")
    print("\n\t\tFormat:")
    print("\t\tStock Analyzer> chart")
    print("\t\tCompany> upper\n")

def reportDef():
    print("\n\t-------------------------------------------------------------------------------------------------------------------\n")
    print("\t\tDescription:")
    print("\t\tReport generates share report and predicts future outcome.")
    print("\n\t\t1. Simple")
    print("\n\t\t2. Advance")
    print("\n\t\tFormat:")
    print("\t\tStock Analyzer> report")
    print("\t\tType (single/multiple)>  single")
    print("\t\tType (simple/advance)>   simple")
    print("\t\tCompany> upper\n")

def summaryDef():
    print("\n\t-------------------------------------------------------------------------------------------------------------------\n")
    print("\t\tDescription:")
    print("\t\tSummary gives an overview of the market.")
    print("\n\t\tFormat:")
    print("\t\tStock Analyzer> summery")

def resetDef():
    print("\n\t-------------------------------------------------------------------------------------------------------------------\n")
    print("\t\tDescription:")
    print("\t\tReset creates new files by deleting all the existing files.")
    print("\n\t\tFormat:")
