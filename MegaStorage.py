...
fileExtension = '.txt'
fileName1 = 'data1/marketData.txt'
fileName2 = 'data2/'
reportFileName = 'report/'

DataSetPoint = [
    "Name:", "Sector:", "Outstanding Share:", "Market Price:", "120 Day Average:", "1 Year Yield:", 
    "EPS:", "PE:", "Book Value:", "PBV:", "130 Day Average Volume:", "Market Capitalisation:"
]
Symbol = [
